    ...
    <div class="col-md-12" style="margin-top: 60px;">
      <div class="card">
        ...
        <div class="form-group">
          ...
          <input type="Password" name="password" value="<?=$detail->password?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Kosongkan jika tidak ingin mengganti">
        </div>
        <div class="form-group">
